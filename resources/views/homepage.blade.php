...
@section('head')
    ...
    <style>
       ...
       #c1 {
            background-image: url('http://localhost:8000/images/s3.amazonaws.com_upload.uxpin_files_272217_618567_feet-morning-adventure-camping-2.jpg');
...
<div id="c1" class="container-fluid text-center">
    ...
    <!-- <button href="register" id="b1" type="button" class="btn btn-lg btn-danger">Get Yours Started</button> -->
